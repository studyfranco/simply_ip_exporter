...
COPY --from=builder /app/target/release/simply_ip_exporter /usr/local/bin/simply_ip_exporter
...
ENV DATABASE_URL=sqlite://data/simply_ip_exporter.db?mode=rwc
ENV RUST_LOG=info
